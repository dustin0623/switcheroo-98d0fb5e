...
interface EquipmentSlotProps {
  ...
  onUnequip?: ((slot: SlotKey) => void) | undefined;
  onSelect?: ((slot: SlotKey) => void) | undefined;
}

export function EquipmentSlot({ slot, item, onUnequip, onSelect }: EquipmentSlotProps) {
    ...
    >
      ...
      {item ? (
        <>
          ...
          <p className="text-xs text-muted-foreground" title="Power score = SPARKS value if salvaged">
            Power score{" "}

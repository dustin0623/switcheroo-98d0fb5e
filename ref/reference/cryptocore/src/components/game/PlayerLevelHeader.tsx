...
interface PlayerLevelHeaderProps {
  username: string;
  xp: number;
  /** Future shop cosmetic — profile image. */
  avatarUrl?: string;
  /** Future shop cosmetic — gradient/border classes for the avatar ring. */
  borderClassName?: string;
}

/** Avatar + username + level + XP progress bar in a single horizontal row. */
export function PlayerLevelHeader({ username, xp, avatarUrl, borderClassName }: PlayerLevelHeaderProps) {

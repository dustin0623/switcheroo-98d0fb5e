...
/** Permanent-stat upgrade cost: level squared. */
...
export const LUCK_TABLE: BonusTable = [
  [1, 0.025], [2, 0.05], [5, 0.125], [10, 0.25],
  [25, 0.625], [50, 1.25], [100, 2.25], [250, 3.281],
  [500, 4.063], [1000, 5.078], [2000, 5.469], [5000, 6.641],
  [10000, 7.1], [25000, 7.466], [50000, 8.002], [100000, 8.041],
...
export const FIREWALL_TABLE: BonusTable = [
  [1, 0.025], [2, 0.05], [5, 0.125], [10, 0.25],
  [25, 0.625], [50, 1.25], [100, 2.5], [250, 5.625],
  [500, 7.438], [1000, 9.0], [2000, 10.266], [5000, 11.438],

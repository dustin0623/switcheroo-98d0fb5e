...
const STEPS = [
  ...
  },
  {
    ...
    description: "Pick a miner tag. This is how other players see you on raid targets and market listings.",
  },
  {
    icon: Gamepad2,
...
export function LandingPage() {
  ...
  const connected = useAuthStore(
    (state) => state.address !== null && state.username !== null,
  ) && hydrated;
    ...
    <div className="space-y-16 pb-12 pt-4 md:pt-8">
      ...
      <section className="space-y-5">
        <div>
          ...
          <p className="text-xs text-muted-foreground md:text-sm">Get started in three simple steps.</p>
        </div>
        ...
        <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-lg text-xs leading-relaxed text-muted-foreground md:text-sm">
              Demo mode lets you experience the full game loop locally. When you are ready, connect a
              Solana wallet to persist progress on the server and compete with other players.
            </p>
          </div>

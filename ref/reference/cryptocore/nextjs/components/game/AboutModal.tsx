...
import { BookOpen, Check, Copy, ExternalLink, Info, Rocket, Twitter } from "lucide-react";
...
const LINKS = [
  { label: "X (Twitter)", value: "@soulstudio_sol", href: "https://x.com/soulstudio_sol", icon: Twitter },
  { label: "pump.fun", value: "Trade $HASH", href: "https://pump.fun", icon: Rocket },
];
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            $HASH is a community token on Solana powering this idle mining game. Follow the links below to trade, read
            the docs, or keep up with announcements.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="rounded-lg border border-border/60 bg-muted/30 p-3">
          <p className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">Token contract</p>
          <div className="mt-1.5 flex items-center gap-2">
            <code className="min-w-0 flex-1 truncate font-mono text-[11px] text-foreground">{TOKEN_ADDRESS}</code>
            <button
              type="button"
              onClick={copyAddress}

...
export interface PlayerCardProfile {
  ...
  equipped: Equipment[];
  /** Shop cosmetics — plug in when the profile store supports them. */
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] max-w-3xl overflow-y-auto border-border/60 p-0">
        ...
        {/* Cover banner — future: player-purchased background image */}
          ...
          <StatUpgradeCard
            ...
            meta={
              <div className="space-y-1">
                ...
                <div className="text-primary">+{(profile.stats.exploit ?? 0).toFixed(3)}% Exploit</div>
              </div>
            }
          />

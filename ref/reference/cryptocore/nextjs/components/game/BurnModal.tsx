    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <p className="text-sm text-muted-foreground">
          Send HASH to Notoriety to increase your Exploit skill and unlock future content. HASH
          sent to Notoriety stays in the rig.
        </p>
        <div className="mt-4 space-y-2">
          ...
          <div className="space-y-1 border-t border-border/40 pt-2 text-xs text-muted-foreground">
            <div>
              <span className="text-primary">▲</span> Notoriety: +
              {valid ? formatHash(qty) : "0.00"}, Total:{" "}
        ...
        <Button className="mt-4 w-full" variant="outline" disabled={!valid} onClick={confirm}>
          Confirm
        </Button>
      </DialogContent>
    </Dialog>

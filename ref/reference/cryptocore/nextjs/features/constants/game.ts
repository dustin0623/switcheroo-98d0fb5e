...
export const RARITY_KEYS: Rarity[] = [
  "common",
  "uncommon",
  "rare",
  "epic",
...
export const VAULT_BASE_CAPACITY = 40;
/** Extra hours-of-output the vault holds per vault level. */
export const VAULT_CAPACITY_PER_LEVEL = 0.5;
...
export const UPGRADE_TARGET_SECONDS = 4 * 60 * 60;

...
let _gameplaySessionId: string | null = null;

function createGameplaySessionId(): string {
...
/** Stable for the lifetime of one authenticated gameplay mount, including reconnects. */
export function getGameplaySessionId(): string {
  _gameplaySessionId ??= createGameplaySessionId();
  return _gameplaySessionId;
}
...
export function initSocket(): Socket {
  ...
  const socket = io(wsUrl ?? "", {
    auth: { token: token ?? "", sessionId: getGameplaySessionId() },

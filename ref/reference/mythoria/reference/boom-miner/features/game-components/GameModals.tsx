...
export type ModalKey = "heroes" | "shop" | "leaderboard";
const MODAL_KEYS: ModalKey[] = ["heroes", "shop", "leaderboard"];
...
export function GameModals() {
  ...
  return (
    <>
      <HeroesModal      show={active === "heroes"}      onClose={close} onOpenShop={() => setActive("shop")} />

...
export const Route = createFileRoute("/shop")({
  head: () => ({
    meta: [
      { title: "Shop — Mythoria" },
      { name: "description", content: "Purchase chests with $MGOLD to unlock items and gear." },
      { property: "og:title", content: "Shop — Mythoria" },
      { property: "og:description", content: "Purchase chests with $MGOLD to unlock items." },
    ],
  }),
  component: Shop,
});

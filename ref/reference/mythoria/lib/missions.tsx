...
// Public-folder paths — no Vite asset imports needed in Next.js
const stealth = "/assets/mission-stealth.jpg";
const fortune = "/assets/mission-fortune.jpg";
const defense = "/assets/mission-defense.jpg";
const combat = "/assets/mission-combat.jpg";
const salvage = "/assets/mission-salvage.jpg";

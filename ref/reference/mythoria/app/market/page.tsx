...
import type { ItemType, Rarity } from "@/features/types";
...
const ATTR_ORDER: (keyof import("@/features/types").Attributes)[] = [
  "damage",
  "defense",
  "arcane",
  "speed",
          ...
          <tbody>
            ...
            {filtered.map((it) => {
              ...
              const active = ATTR_ORDER
                ...
                .filter(([, v]) => v > 0);
              return (
                <tr key={`${it.item_number}-${it.market?.seller ?? it.edition}`} className="border-t border-border/40 hover:bg-secondary/40 align-top">
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="font-mono font-semibold">{fmt(Number(it.market?.price ?? 0), 3)}</div>

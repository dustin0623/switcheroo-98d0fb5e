...
export const ShareStatsCard = forwardRef<HTMLDivElement, ShareStatsCardProps>(
  function ShareStatsCard(
    ...
    const stats = [
      { label: "VAULT", value: `${formatHash(vault, 2)} HASH`, sub: `${formatPercent(fillPercent, 1)} full` },
      { label: "HASH RATE", value: `${formatInt(hashRate)} H/s`, sub: `${formatHash(perSecond, 2)} / sec` },
      { label: "HACK POWER", value: formatInt(hackPower), sub: `Raids targets <${formatInt(hackPower)} sec` },
      { label: "SECURITY", value: formatInt(security), sub: `Blocks HP up to ${formatInt(security)}` },
    ...
    return (
      ...
      >
        ...
        <div style={{ position: "relative", padding: "0 32px 28px", marginTop: -36 }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", gap: 16, marginBottom: 20 }}>
            ...
            <div style={{ flex: 1, paddingBottom: 4 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
                <span style={{ fontSize: 26, fontWeight: 800, letterSpacing: -0.5 }}>{username}</span>
                <span
                  style={{
                    display: "inline-flex",
                    alignItems: "center",
          ...
          >
            {stats.map(({ label, value }) => (
              ...
              >
                ...
                <div style={{ fontSize: 22, fontWeight: 800, color: "#e5484d" }}>
                  {value}
                </div>
              </div>
            ))}
          ...
          {/* Footer */}
          <div style={{ marginTop: 20, fontSize: 11, color: "#374151", textAlign: "center", letterSpacing: 0.5 }}>

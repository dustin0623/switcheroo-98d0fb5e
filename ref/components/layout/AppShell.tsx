...
import { getBackgroundByTemplateId, DEFAULT_BACKGROUND_TEMPLATE_ID } from "@/features/templates/backgrounds";
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  const backgroundId = connected ? (selectedBackgroundId ?? DEFAULT_BACKGROUND_TEMPLATE_ID) : DEFAULT_BACKGROUND_TEMPLATE_ID;

...
import { getMintPublicKey, getSolanaConnection, HASH_TOKEN_PROGRAM_ID } from "@/lib/chain/solana/client";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return jsonResponse({ ok: true, balance: balance.value.uiAmount ?? 0 }, request, { status: 200 });
  } catch {
